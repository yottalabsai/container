...
target "280-py311-cuda1281-cudnn-devel-ubuntu2204" {
    ...
    tags = ["${PUBLISHER}/pytorch:2.8.0-py3.11-cuda12.8.1-cudnn-devel-ubuntu22.04-2025081801"]
    tags = ["${PUBLISHER}/pytorch:2.8.0-py3.11-cuda12.8.1-cudnn-devel-ubuntu22.04-2025060601"]
    contexts = {
