...
> **Note:** data stored in `/workspace/comfyui` will be deleted when the Pod is deleted, unless you're using a [network volume](https://docs.yottalabs.ai/yotta-labs/pods/storage/create-network-volumes).
...
- For technical support, consider:
  - [Yotta Labs Community on Discord](https://discord.gg/cUpRmau42V)
