...
target "cpu" {
    ...
    tags = ["yottalabsai/base:${RELEASE}-cpu"]
    contexts = {
...
target "11-1-1" {
    dockerfile = "${GITHUB_WORKSPACE}/official-templates/base/Dockerfile"
    tags = ["yottalabsai/base:${RELEASE}-cuda11.1.1"]
    contexts = {
        scripts = "${GITHUB_WORKSPACE}/container-template"
        proxy = "${GITHUB_WORKSPACE}/container-template/proxy"
        logo = "${GITHUB_WORKSPACE}/container-template"
...
target "11-8-0" {
    dockerfile = "${GITHUB_WORKSPACE}/official-templates/base/Dockerfile"
    tags = ["yottalabsai/base:${RELEASE}-cuda11.8.0"]
    contexts = {
        scripts = "${GITHUB_WORKSPACE}/container-template"
        proxy = "${GITHUB_WORKSPACE}/container-template/proxy"
        logo = "${GITHUB_WORKSPACE}/container-template"
...
target "12-1-0" {
    dockerfile = "${GITHUB_WORKSPACE}/official-templates/base/Dockerfile"
    tags = ["yottalabsai/base:${RELEASE}-cuda12.1.0"]
    contexts = {
        scripts = "${GITHUB_WORKSPACE}/container-template"
        proxy = "${GITHUB_WORKSPACE}/container-template/proxy"
        logo = "${GITHUB_WORKSPACE}/container-template"
...
target "12-2-0" {
    dockerfile = "${GITHUB_WORKSPACE}/official-templates/base/Dockerfile"
    tags = ["yottalabsai/base:${RELEASE}-cuda12.2.0"]
    contexts = {
        scripts = "${GITHUB_WORKSPACE}/container-template"
        proxy = "${GITHUB_WORKSPACE}/container-template/proxy"
        logo = "${GITHUB_WORKSPACE}/container-template"
...
target "12-4-1" {
    ...
    tags = ["yottalabsai/base:${RELEASE}-cuda12.4.1"]
    contexts = {
...
target "12-5-1" {
    dockerfile = "Dockerfile"
    tags = ["yottalabsai/base:${RELEASE}-cuda12.5.1"]
    contexts = {
        scripts = "../../container-template"
        proxy = "../../container-template/proxy"
        logo = "../../container-template"
...
target "12-6-2" {
    dockerfile = "Dockerfile"
    tags = ["yottalabsai/base:${RELEASE}-cuda12.6.2"]
    contexts = {
        scripts = "../../container-template"
        proxy = "../../container-template/proxy"
        logo = "../../container-template"
