...
The container is now accessible via a browser : `https://<IP>:6901`
 ...
 ### How to build:
CUDA 11.8
 ```docker buildx build -f dockerfile-kasm-core-11 -t yottalabs/kasm-docker:cuda11 --build-arg START_XFCE4=1 --build-arg START_PULSEAUDIO=1 .```
...
As we run it on console.yottalabs.ai you get GPU acceleration access that allows you to run programs like you can do on normal linux PC. This image is customized to allow user to access to sudo command for full root access.
