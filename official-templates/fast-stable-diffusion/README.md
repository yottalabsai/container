...
This is a packaged template for Fast Stable Diffusion, Yotta Labs does not maintain the code for this repo, we just package it so that it's easier for you to use.
...
The best ways to get your models onto your pod is by using [yottactl](https://github.com/yottalabsai/yottactl/blob/main/README.md) or by uploading them to google drive or other cloud storage and downloading them to your pod from there. You should put models that you want to use with auto in the /workspace/auto-models directory.

### Uploading to google drive

If you're done with the pod and would like to send things to google drive, you can use [this colab](https://colab.research.google.com/drive/1ot8pODgystx1D6_zvsALDSvjACBF1cj6) to do it using yottactl. You run the yottactl either in a web terminal (found in the pod connect menu), or in a terminal on the desktop
